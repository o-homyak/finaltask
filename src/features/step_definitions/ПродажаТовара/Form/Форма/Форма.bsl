...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯПодготавливаюВспомагательныеДанные()","ЯПодготавливаюВспомагательныеДанные","Допустим я подготавливаю вспомагательные данные");
...
//@ЯПодготавливаюВспомагательныеДанные()
Процедура ЯПодготавливаюВспомагательныеДанные() Экспорт
	ЗагрузитьFixtureИзМакета("Товары");
	ЗагрузитьFixtureИзМакета("Покупатели");
КонецПроцедуры
